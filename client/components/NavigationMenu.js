    ...
    <ListItem css={{ gridRow: 'span 3' }}>
      <NavigationMenuLink
        ...
        css={{
          ...
          width: '100%',
          height: '100%',
          background: `linear-gradient(160deg, ${blue.blue9} 0%, ${plum.plum8} 100%);`,
          borderRadius: 6,
          padding: 25,
        }}>
    ...
    <ListItem css={{ gridRow: 'span 3' }}>
      <NavigationMenuLink
        ...
        css={{
          ...
          width: '100%',
          height: '100%',
          background: `linear-gradient(200deg, ${blue.blue9} 0%, ${plum.plum8} 100%);`,
          borderRadius: 6,
          padding: 25,
        }}>
...
const ContentListItemFreelancerCreate = React.forwardRef(
  ({ children, ...props }, forwardedRef) => (
    <ListItem css={{ gridRow: 'span 3' }}>
      <NavigationMenuLink
        {...props}
        ...
        css={{
          ...
          width: '100%',
          height: '100%',
          background: `linear-gradient(200deg, ${mauve.mauve12} 0%, ${mauve.mauve10} 100%);`,
          borderRadius: 6,
          padding: 25,
        }}>
        <AssignmentTwoToneIcon style={{ color: '#ffffff' }} />
        <LinkTitle
          css={{
            fontSize: 18,
            color: 'white',
        ...
        <LinkText
          ...
          Знайдіть постійну роботу віддалено чи в офісі
        </LinkText>
        <LinkText
          css={{
            fontSize: 16,
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ContentList layout='two'>
              ...
              <ContentListItemFreelancerCreate />
            </ContentList>
          </NavigationMenuContent>
        </NavigationMenuItem>
